            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="website.html"><b> Home </b></a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="http://localhost/IP%20Project/dorm1.php"><b>Dorm Room Requisition</b></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="website.html #contact"><b>Contact Us</b></a>
                  </li>
                </ul>
              </div>
            </div>
